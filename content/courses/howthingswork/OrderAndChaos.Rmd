...
---
## Introduction
The is a  repository of ideas for this course. The idea is to deliver many ideas from **Complexity Science** and relate them to *Life and Human Experiences*.  That can form the basis for **Model based Thinking** as a way of living and working.  
...
#### Human Behaviour and Game theory
   ...
   - Stag Hunt Game - Prank the Class with overnight email on dress/costume
   - William Poundstone on [Stag Hunt](http://www.heretical.com/pound/staghunt.html)
   - Carly Rae Jepsen and PD/SH [Call Me, Maybe](https://duckofminerva.com/2012/07/call-me-maybe-cooperation-and-coercion.html)
   - Nash Equlibria - Single and Multiple
   - Other Games : Chicken
